...
public class RegExToNFA {
  public static void main(String[] args) {
    ...
    if (regExStr.length() < 1) {
      ...
      try {
        ...
        Automaton automaton = buildAutomaton(ret);
  ...
  private static Automaton alternate(Automaton a1, Automaton a2) {
    ...
    automaton.addTransition(new Transition(a1.getAcceptingState(), end, Transition.EPSILON));
    automaton.addTransition(new Transition(a2.getAcceptingState(), end, Transition.EPSILON));
  ...
  private static Automaton kleeneStar(Automaton a) {
    ...
    automaton.addTransition(new Transition(a.getAcceptingState(), end, Transition.EPSILON));
    automaton.addTransition(new Transition(a.getAcceptingState(), a.getStartState(), Transition.EPSILON));
